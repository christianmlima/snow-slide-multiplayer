...
class SnowSlideTPSMasterEngine {
    ...
    createDetailedPenguin() {
        ...
        const handSnowball = new THREE.Mesh(new THREE.SphereGeometry(0.12, 10, 10), new THREE.MeshStandardMaterial({ color: 0xf8fafc, roughness: 0.5 }));
    ...
    createDetailedFrog() {
        ...
        const createVinylFrogFoot = (posX) => {
            const foot = new THREE.Group();
