        ...
        if (insertCount > 0) {
            ...
            for (let i = 0; i < reuse; i++) {
                ...
                if (u !== -1) {
                    ...
                    op = (deletedIndexes[addIndex]) ? OPERATION.DELETE_AND_ADD : OPERATION.ADD;
                }
...
class StateView {
    ...
    addParentOf(childChangeTree, tag) {
        ...
        if (changeTree.getChange(parentIndex) !== OPERATION.DELETE) {
            ...
            changes.set(changeTree.isArray ? childChangeTree : parentIndex, OPERATION.ADD);
        }
    }
    /**
            ...
            if (st !== undefined) {
                ...
                if (sent !== undefined && sent.size > 0) {
                    ...
                    for (const pos of sent)
                        changes.set(pos, OPERATION.DELETE);
                    sent.clear();
                }
            }
            return this;
